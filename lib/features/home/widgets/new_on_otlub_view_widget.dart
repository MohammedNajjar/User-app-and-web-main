...
class NewOnotlubViewWidget extends StatelessWidget {
  final bool isLatest;
  const NewOnotlubViewWidget({super.key, required this.isLatest});
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    restController.latestRestaurantList != null
                        ...
                        : const RestaurantsCardShimmer(isNewOnotlub: false),
                  ],
                ),
              ),
            );
