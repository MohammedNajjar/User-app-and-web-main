                      ...
                      children: [
                        Padding(
                          ...
                          child: PageView.builder(
                            ...
                            itemCount:
                                (homeController.bannerImageList!.length / 2)
                                    .ceil(),
                            itemBuilder: (context, index) {
                              ...
                              String? baseUrl1 =
                                  homeController.bannerDataList![index1]
                              ...
                              String? baseUrl2 = hasSecond
                                  ? homeController.bannerDataList![index2]
                                          is BasicCampaignModel
                                      ? Get.find<SplashController>()
                                          .configModel!
                                          .baseUrls!
                                ...
                                Expanded(
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: CustomImageWidget(
                                      image:
                                          '$baseUrl1/${homeController.bannerImageList![index1]}',
                                      fit: BoxFit.cover,
                                      height: 220,
                                    ),
                                  ),
                                    ...
                                    child: hasSecond
                                        ? InkWell(
                                            ...
                                            child: ClipRRect(
                                              ...
                                              child: CustomImageWidget(
                                                image:
                                                    '$baseUrl2/${homeController.bannerImageList![index2]}',
                                                fit: BoxFit.cover,
                                                height: 220,
                                              ),
                                            ),
