...
import 'package:otlub_multivendor/features/home/widgets/restaurants_card_widget.dart';
...
class WebNewOnotlubViewWidget extends StatelessWidget {
  final bool isLatest;
  const WebNewOnotlubViewWidget({super.key, required this.isLatest});
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    restController.latestRestaurantList != null
                        ...
                        : const RestaurantsCardShimmer(isNewOnotlub: true),
                  ],
                ),
              ),
            );
