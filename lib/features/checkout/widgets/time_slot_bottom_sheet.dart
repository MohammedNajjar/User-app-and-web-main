...
import 'package:otlub_multivendor/features/checkout/domain/models/date_month_body_model.dart';
import 'package:otlub_multivendor/features/checkout/widgets/slot_widget.dart';
                            ...
                            SizedBox(
                              ...
                              child: Row(children: [
                                ...
                                (isRestaurantSelfDeliveryOn
                                        ? widget
                                            .restaurant.customerDateOrderStatus!
                                                ...
                                                itemBuilder: (context, index) {
                                                  String time = (index == 0 &&
                                                          ...
                                                          DateTime(
                                                                  ...
                                                                  DateTime.now()
                                                                      .day)
                                                              .isAtSameMomentAs(checkoutController
                                                                      .selectedCustomDate ??
                                                                  DateTime(
                                                                      DateTime.now()
                                                                          .year,
