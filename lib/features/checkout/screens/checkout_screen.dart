...
import 'package:otlub_multivendor/features/checkout/widgets/bottom_section_widget.dart';
import 'package:otlub_multivendor/features/checkout/widgets/checkout_screen_shimmer_view.dart';
import 'package:otlub_multivendor/features/checkout/widgets/order_place_button.dart';
import 'package:otlub_multivendor/features/checkout/widgets/top_section_widget.dart';
...
class CheckoutScreenState extends State<CheckoutScreen> {
              ...
              return GetBuilder<CheckoutController>(
                ...
                return GetBuilder<CouponController>(
                  ...
                  double orderAmount = _calculateOrderAmount(
                      price, addOnsPrice, discount, couponDiscount);
                  bool taxIncluded =
                  ...
                  debugPrint(
                      '=====check : ${checkoutController.distance != null} && ${checkoutController.restaurant != null}');
  ...
  double _calculateOrderAmount(double price, double addOnsPrice,
      double discount, double couponDiscount) {
