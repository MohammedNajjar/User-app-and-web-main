...
import 'package:otlub_multivendor/common/widgets/custom_loader_widget.dart';
...
import 'package:otlub_multivendor/features/location/widgets/permission_dialog.dart';
import 'package:otlub_multivendor/features/location/widgets/pick_map_dialog.dart';
                ...
                CustomButtonWidget(
                  ...
                  onPressed: () async {
                    _checkPermission(() async {
                      Get.find<LocationController>().bypasslocation = true;
                ...
                TextButton(
                  ...
                  onPressed: () {
                    if (ResponsiveHelper.isDesktop(Get.context)) {
                      ...
                      Get.find<LocationController>().bypasslocation = false;
                      Get.toNamed(RouteHelper.getPickMapRoute(
                        route ??
                            (fromSignUp
                                ? RouteHelper.signUp
